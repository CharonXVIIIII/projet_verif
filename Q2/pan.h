...
#define _nstates1	28	/* ProcessusQ */
#define minseq1	27
#define maxseq1	53
#define _endstate1	27

#define _nstates0	28	/* ProcessusP */
#define minseq0	0
#define maxseq0	26
...
#define PProcessusQ	((P1 *)_this)
typedef struct P1 { /* ProcessusQ */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define PProcessusP	((P0 *)_this)
typedef struct P0 { /* ProcessusP */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
